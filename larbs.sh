...
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/syleepaguy/DWMonVoid/master/progs.csv"
...
%wheel ALL=(ALL) NOPASSWD: /usr/bin/shutdown,/usr/bin/reboot,/usr/bin/xbps-install -Syu
